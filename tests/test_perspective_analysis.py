...
from exceptions import (
    OpenAIError, OpenAIAPIError, OpenAIResponseError, 
    PerspectiveAnalysisError, ThemeAnalysisError
)
...
class TestPerspectiveAnalysisComplexLogic(unittest.TestCase):
    ...
    def test_quote_ranking_fallback_strategies(self):
        ...
        mock_client.chat.completions.create.side_effect = [
            ...
            Mock(choices=[Mock(message=Mock(content='{"quote_index": 1, "relevance_score": 8}'))])  # Fallback succeeds
        ]
    ...
    def test_quote_ranking_validation(self):
        ...
        result = JSONParser.extract_and_validate_quotes_ranking(invalid_response, quotes)
    ...
    def test_quote_selection_stage_tracking(self):
        ...
        rankings = [
            {'quote_index': 1, 'relevance_score': 8, 'relevance_explanation': 'test', 'key_insight': 'insight'}
        ]
    ...
    def test_complex_fallback_chaining(self):
        ...
        mock_client.chat.completions.create.side_effect = [
            ...
            Mock(choices=[Mock(message=Mock(content='{"quote_index": 1, "relevance_score": 8}'))])  # Second fallback succeeds
        ]
