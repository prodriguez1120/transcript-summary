        ...
        incomplete_takeaways = [
            {
                ...
                "supporting_quotes": [
                    {"text": "We are number one", "transcript_name": "Test"}
                ],
            }
        ]
...
1. Market Leadership
   ...
   - Market dominance - Analyst from Market Report"""
        ...
        sections = self.tool._parse_all_sections(
            response_with_citations, self.sample_quotes
        )
...
2. Second weakness
   - "Quote 7" - Speaker from Transcript"""
        ...
        sections = self.tool._parse_all_sections(
            response_with_transitions, self.sample_quotes
        )
...
1. Market Leadership
   ...
   - "Number one position" - Jane Smith, Manager from Industry Analysis"""
        ...
        sections = self.tool._parse_all_sections(
            response_with_metadata, self.sample_quotes
        )
...
class TestDataStructureValidation(unittest.TestCase):
    ...
    def test_structure_enforcement(self):
        ...
        sections = {
            ...
            "weaknesses": [{"insight": "Weakness 1", "supporting_quotes": []}],
        }
