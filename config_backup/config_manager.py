...
class ConfigManager:
    ...
    def __init__(
        self, company_name: str = "flexxray", config_file: str = "company_settings.json"
    ):
    ...
    def load_custom_settings(self):
        ...
        if os.path.exists(self.config_file):
            try:
                ...
                self.logger.warning(
                    f"Data validation error loading custom settings: {e}"
                )
    ...
    def create_transcript_directory(self) -> bool:
        ...
        try:
            ...
            print(
                f"Transcript directory created: {self.company_config.transcript_directory}"
            )
            return True
        except (IOError, OSError) as e:
...
def get_config_manager(company_name: str = "flexxray") -> ConfigManager:
    ...
    if (
        _global_config_manager is None
        or _global_config_manager.current_company != company_name
    ):
...
if __name__ == "__main__":
    ...
    new_company = config_mgr.create_new_company(
        ...
        question_categories={"key_takeaways": ["product_fit", "competitive_edge"]},
    )
