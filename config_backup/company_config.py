...
def create_custom_company_config(
    ...
    **kwargs,
    ...
    custom_config = CompanyConfig(
        ...
        business_insights=kwargs.get(
            "business_insights", base_config.business_insights
        ),
        topic_synonyms=kwargs.get("topic_synonyms", base_config.topic_synonyms),
        industry_keywords=kwargs.get(
            "industry_keywords", base_config.industry_keywords
        ),
