...
class DocumentProcessor:
    ...
    def _check_dependencies(self):
        ...
        try:
            ...
            logger.warning("python-docx not available. Word documents cannot be processed.")
        ...
        try:
            ...
            try:
                ...
                logger.warning("PyPDF2/pypdf not available. PDF files cannot be processed.")
    ...
    def _extract_text_from_docx(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            full_text = '\n'.join(text_parts)
            logger.info(f"Successfully extracted {len(full_text)} characters from Word document: {file_path}")
            return full_text
            ...
            if hasattr(self, 'pypdf_available') and self.pypdf_available:
                try:
                    ...
                    with open(file_path, 'rb') as file:
                        ...
                        full_text = '\n'.join(text_parts)
                        logger.info(f"Successfully extracted {len(full_text)} characters from PDF using PyPDF2: {file_path}")
                        return full_text
                ...
                try:
                    ...
                    with open(file_path, 'rb') as file:
                        ...
                        full_text = '\n'.join(text_parts)
                        logger.info(f"Successfully extracted {len(full_text)} characters from PDF using pypdf: {file_path}")
                        return full_text
            ...
            if file_path.is_file() and file_path.suffix.lower() in supported_formats:
                ...
                if doc_info:
                    ...
                    if text:
                        ...
                        doc_info['text_preview'] = text[:200] + "..." if len(text) > 200 else text
    ...
    def validate_document(self, file_path: str) -> Dict[str, Any]:
        ...
        if file_ext == '.docx':
            ...
            if not self.docx_available:
                validation_result['validation_message'] = "python-docx library not available"
                return validation_result
        elif file_ext == '.pdf':
            validation_result['dependencies_available'] = self.pypdf_available
            if not self.pypdf_available:
                validation_result['validation_message'] = "PDF processing libraries not available"
                return validation_result
        
        validation_result['can_process'] = True
        validation_result['validation_message'] = "Document can be processed successfully"
