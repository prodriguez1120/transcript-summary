...
def wrap_exception(
    exception: Exception, context: str, details: str | None = None
) -> FlexXrayError:
    ...
    if isinstance(exception, (ValueError, TypeError)):
        ...
        return DocumentReadError(
            f"File operation failed in {context}", details, exception
        )
        ...
        return ChromaDBConnectionError(
            f"Connection failed in {context}", details, exception
        )
    else:
